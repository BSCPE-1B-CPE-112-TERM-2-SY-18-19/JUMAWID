...
int main() 
	...
	long banol::wasteful_number(long num2) {	
	n=num2;
	x=n;
	digit=0;
	for (;n!=0;)
	...
	void banol::exam(long num[1000],long size){
		banol jefrey;
		if(jefrey.wasteful_number(size)==1){
			cout<<" - WASTEFUL NUMBER"<<endl;
			cout<<"Sorted: ";
			jefrey.sorting_ascending(num,size);
			cout<<endl;
		}
		else
		{
	...
	void banol::sorting_ascending(long num[1000],long size)
		{
			long temp1;
			for(i=0;i<size;i++)
				{
